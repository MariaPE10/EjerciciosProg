...
public class codigo02 {
	...
	// Ejercicio 4: Reforma el ejercicio anterior, para que el l�mite sea tambi�n introducido por el usuario.
	 ...
	 * el usuario introduzca el n�mero 0 (cero), que no debe tenerse en cuenta para ninguna operaci�n aritm�tica,
	 * simplemente para salir de la aplicaci�n. Cuando el programa haya terminado, se debe sacar en pantalla el valor 
	...
	public static void BuclesB3Ej2 () {
		...
		JOptionPane.showMessageDialog(null, "La media de los numeros introducidos es: " + ((float) suma/(i-1)));
	}	
	...
	/* Ejercicio 5: Realiza un ejercicio parecido a los dos anteriores, d�nde se imprima el mayor
