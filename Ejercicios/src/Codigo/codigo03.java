...
public class codigo03 {
	 ...
	 * mayor de todos los nÃºmeros que aparecen en el array.
	 */
	 ...
	 * entre un lÃ­mite inferior y uno superior que debe especificar el usuario. Debes mostrar el
	 ...
	 * DespuÃ©s de su inicializaciÃ³n debÃ©is imprimir el array en orden inverso.
	 */
	 ...
	 * A continuaciÃ³n pedirÃ¡s al usuario un valor y buscarÃ¡s dicho valor en el array. Si lo encuentras, debes
	 * indicar al usuario la posiciÃ³n del array en que se encuenta. En caso de que no encuentres el valor buscado,
	 * debes indicÃ¡rselo tambiÃ©n al usuario.
	 */
	 ...
	 * Debes obtener la suma de los nÃºmeros pares y los impares en variables separadas. 
	 */
	 ...
	 * dentro de una funciÃ³n. Debes mostrar al usuario la suma de los elementos cuyo Ã­ndice sea par.
	 */
	 ...
	 * entre -100 y 100. Debes conseguir que todos los nÃºmeros pares del array cambien de signo, los positivos
	 ...
	 * Ã­ndice impar del tercer array debes copiar los elementos de Ã­ndice impar del primer array; en los
	 * elementos de Ã­ndice par del tercer array debes copiar los elementos de Ã­ndice par del segundo array.
	 */
	 ...
	 * y 100. Debes conseguir multiplicar cada uno de los elementos del array por un nÃºmero determinado,
	 * pedido al usuario.
	 */
	 ...
	 * Debes conseguir que se desplacen los nï¿½meros un lugar a su derecha, de manera que el desplazamiento sea circular,
	 * si un nï¿½mero sale por la derecha volverï¿½ a entrar por la izquierda. Ejemplo: 1 2 3 4 5 pasa a ser 5 1 2 3 4 que
