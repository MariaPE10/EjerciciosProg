...
public class ApartadoB {
	/* Crea una clase con un mÃ©todo â€œmainâ€� que cree un array con 100 elementos de
	 * longitud, los elementos deben ser nÃºmeros enteros al azar comprendidos entre dos lÃ­mites, que
	 * deben ser preguntados al usuario. Muestra el array en orden normal y tambiÃ©n en orden 
	 * invertido.
	 */
