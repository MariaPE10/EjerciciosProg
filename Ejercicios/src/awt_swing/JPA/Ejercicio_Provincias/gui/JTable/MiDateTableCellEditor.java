...
public class MiDateTableCellEditor extends DefaultCellEditor {
	...
	public MiDateTableCellEditor(DateFormat format) {
		...
		// La edici�n comenzar� con dos clics de rat�n
	...
	/**
	 * En caso de que el valor introducido por el usuario no sea v�lido, se mantendr� el anterior valor introducido v�lido.
	 */
	public boolean stopCellEditing() {
		...
		} else { // El texto introducido no es v�lido
			ftf.setValue(ftf.getValue());
		}
