...
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.ControladorBBDDCliente;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.ControladorBBDDCoche;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.ControladorBBDDConcesionario;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.ControladorBBDDFabricante;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.ControladorBBDDVentas;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.entidades.Cliente;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.entidades.Coche;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.entidades.Concesionario;
import awt_swing.ejercicio3_BBDDRegistroCoches_JDBC.modelo.entidades.Venta;
		...
		this.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (e.getUnitsToScroll() < 0) {
					if (ControladorBBDDVentas.getSiguienteVenta(venta) != null) {
						navegaASiguiente();
					}
				}
				else {
					if (ControladorBBDDVentas.getAnteriorVenta(venta) != null) {
						navegaAAnterior();
					}
				}
			}
...
//		this.add(jtfId, gridBagConstraints);
	...
	private void inicializaComboBoxCliente () {
		List<Cliente> clientes = ControladorBBDDCliente.getTodosClientes();
	...
	private void inicializaComboBoxCoche () {
		List<Coche> coches = ControladorBBDDCoche.getTodosCoches();
