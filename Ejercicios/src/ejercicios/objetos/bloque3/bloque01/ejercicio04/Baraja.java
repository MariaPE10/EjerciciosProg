package ejercicios.objetos.bloque3.bloque01.ejercicio04;
...
public class Baraja {
	...
	private void mezclar () {
		...
		for (int i = 0; i < 100; i++) {
			int indiceAzar1 = Utils.obtenerNumeroAzar(0, cartas.length-1); // 6
			int indiceAzar2 = Utils.obtenerNumeroAzar(0, cartas.length-1); // 25
