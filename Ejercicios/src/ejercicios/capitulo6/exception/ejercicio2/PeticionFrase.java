 ...
 * Las excepciones, creadas por ti, deben realizarse en los siguientes casos:
    ...
    - En la frase aparece una palabra ofensiva de la siguiente relaci�n: "tonto", "tonta", "idiota".
   Cada uno de los supuestos anteriores provocar� un tipo diferente de excepci�n. T� debes controlar todos los tipos y responder al usuario con un	mensaje adecuado.*/
